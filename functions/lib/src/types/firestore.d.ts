...
export interface FirestoreContact {
    ...
    status: string;
    enriched_data: {
        website_status: any | null;
        zip_code: string | null;
        address: string | null;
        gmb_data: GmbData;
        website_analysis: any | null;
    };
}
...
export interface BandedCluster {
    primary: string;
    related?: string[];
    cluster_keywords_details: ScoredKeyword[];
...
export interface LlmInputObjects {
    ...
    targetedBlob: any;
    arbitrageData: ArbitrageDataDocument | undefined;
    avgJobAmount: number;
    lead_serp: {
